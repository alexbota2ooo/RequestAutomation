...
{
    public class SickLeaveCommand : ICommand
    {
        private readonly IRepository repo;
        private readonly IEmailSender emailSender;

        public string CommandName { get => Constants.CommandNames.SickCommand; }
        ...
        public SickLeaveCommand(IRepository repository, IEmailSender emailSender)
        {
